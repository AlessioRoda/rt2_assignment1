...
\begin{DoxyCompactList}\small\item\em Callback to get the current odom position of the robot. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em In the main there are the initialization of the publisher, th subscriber and the Simple\+Action\+Server. \end{DoxyCompactList}\end{DoxyCompactItemize}
