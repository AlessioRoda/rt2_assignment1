...
This node has the purpose to generate a random postiion in terms of x, y and theta coordinates from a range that is defined in the /state\+\_\+machine. Once it has created, it sends it via Random\+Position custom service message to the /state\+\_\+machine node.  
