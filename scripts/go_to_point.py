...
#
# current posiotion is saved in terms of x, y and z coordinates and w orientation
##
def clbk_odom(msg):
...
##
# 
# \brief Function to perform the motion of the robot to reach the goal
...
## 
# 
# \brief Get the velocity from the sliders
